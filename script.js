document.addEventListener('DOMContentLoaded', function () {
  ...
  function showFormSuccess(form) {
    ...
    if (!successMsg) {
      ...
      successMsg.style.cssText = 'padding:12px 16px;background:#c6f6d5;color:#276749;border-radius:6px;margin-top:12px;';
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .catch(function (err) {
          ...
          errorDiv.style.cssText += 'padding:10px;background:#fff5f5;border-radius:4px;margin-top:8px;';
  ...
  // ============================================================
  const animationClass = 'fade-in-visible';
  const observerTargetClass = 'fade-in';
  ...
  if (!prefersReducedMotion && 'IntersectionObserver' in window) {
    ...
    document.querySelectorAll('.' + observerTargetClass).forEach(function (el) {
    ...
    const mutationObserver = new MutationObserver(function (mutations) {
      mutations.forEach(function (mutation) {
        mutation.addedNodes.forEach(function (node) {
          ...
          if (node.classList && node.classList.contains(observerTargetClass)) {
            scrollObserver.observe(node);
          }
          node.querySelectorAll && node.querySelectorAll('.' + observerTargetClass).forEach(function (el) {
            scrollObserver.observe(el);
          });
        });
      });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1727b029-51d0-4ad2-ad1d-733168384746',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1727b029-51d0-4ad2-ad1d-733168384746';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1727b029-51d0-4ad2-ad1d-733168384746';
